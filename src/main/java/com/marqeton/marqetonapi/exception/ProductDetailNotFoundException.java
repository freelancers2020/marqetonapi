...
public class ProductDetailNotFoundException extends RuntimeException{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6949372537850855614L;
	...
	public ProductDetailNotFoundException(String message, Throwable cause, boolean enableSuppression,
